...
public class ScheduleController {
    ...
    //스케줄 생성하기
    @PostMapping
    public ResponseEntity<ScheduleResponseDto> createSchedule(@RequestBody ScheduleRequestDto reqeustDto){
        ScheduleResponseDto responseDto = scheduleService.createSchedule(reqeustDto);
